...
```{r}
transect <- mydata %>%
  group_by(nome_UC,estacao_amostral) %>%
...
##Seleção por critérios \### Selecionar UCs Seleção de UCs com mais de 1 ano de amostragem e mais de 149 km de esforço anual.

...
taxateste <- subset(taxas_anuais, select = -cnuc)

taxas_anuaisG <- melt(taxateste, id = c("populacao"))

unique(taxasAnuais99$populacao)
unique(taxasAnuais99$cnuc)

unique(taxasAnuais00$populacao)
unique(taxasAnuais00$cnuc)
...
melted1 <- mini_iris %>% melt(id.vars = "Species")

...
use.this <- subset(encounter_rate, mean >= 0.5 & min > 0) # usar somente espécies com taxa de avistamento médio > 0.1
...
# save jpeg
jpeg(here("experimental", "Callicebus_cazumba.jpg"), width=1000, height=600, res=120) # Open jpeg file
state.space.model(y, n.years)
dev.off()
...
state.space.model(y, n.years)
# save jpeg
jpeg(here("experimental", "Tinamus_cazumba.jpg"), width=1000, height=600, res=120) # Open jpeg file
state.space.model(y, n.years)
dev.off()

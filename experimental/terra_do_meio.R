...
# para os testes usar dados de tdm-Iracema
tdm <- subset(dadosICMBio, nome.UC == "Esec Terra do Meio")

# ... e somente mamiferos 
tdm <- subset(tdm, Classe == "Mammalia")
head(tdm)
dim(tdm)
...
encounter_rate <- encounter_rate[,-c(8:10)]
encounter_rate
#head(encounter_rate)
dim(encounter_rate)
...
# save jpeg
jpeg(here("experimental", "Ateles_tdm.jpg"), width=1000, height=600, res=120) # Open jpeg file
state.space.model(y, n.years)
dev.off()
...
state.space.model(y, n.years)
# save jpeg
jpeg(here("experimental", "Callicebus_tdm.jpg"), width=1000, height=600, res=120) # Open jpeg file
state.space.model(y, n.years)
dev.off()
...
state.space.model(y, n.years)
# save jpeg
jpeg(here("experimental", "Dasyprocta_tdm.jpg"), width=1000, height=600, res=120) # Open jpeg file
state.space.model(y, n.years)
dev.off()
...
state.space.model(y, n.years)
# save jpeg
jpeg(here("experimental", "Guerlinguetus_tdm.jpg"), width=1000, height=600, res=120) # Open jpeg file
state.space.model(y, n.years)
dev.off()

mean_r_Guerlinguetus <- c(mean(meanR), quantile(meanR, probs = c(0.025, 0.975)) )

# Mazama
y  <- as.numeric(encounter_rate[5, 3:ncol(encounter_rate)])
state.space.model(y, n.years)
# save jpeg
jpeg(here("experimental", "Mazama_tdm.jpg"), width=1000, height=600, res=120) # Open jpeg file
state.space.model(y, n.years)
dev.off()
...
state.space.model(y, n.years)
# save jpeg
jpeg(here("experimental", "Pecari_tdm.jpg"), width=1000, height=600, res=120) # Open jpeg file
state.space.model(y, n.years)
dev.off()
...
state.space.model(y, n.years)
# save jpeg
jpeg(here("experimental", "Saimiri_tdm.jpg"), width=1000, height=600, res=120) # Open jpeg file
state.space.model(y, n.years)
dev.off()
...
state.space.model(y, n.years)
# save jpeg
jpeg(here("experimental", "Sapajus_tdm.jpg"), width=1000, height=600, res=120) # Open jpeg file
state.space.model(y, n.years)
dev.off()
...
#
meanRs <- rbind(mean_r_Ateles, mean_r_Callicebus, mean_r_Dasyprocta, mean_r_Guerlinguetus, mean_r_Mazama, mean_r_Pecari, mean_r_Saimiri, mean_r_Sapajus)
...
write.csv(tabela1, here("experimental", "tabela1_terra_do_meio.csv"), row.names = FALSE)

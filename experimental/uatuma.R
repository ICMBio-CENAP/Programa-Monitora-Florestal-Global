...
# para os testes usar dados de uatuma-Iracema
uatuma <- subset(dadosICMBio, nome.UC == "Rebio do Uatumã")

# ... e somente mamiferos 
uatuma <- subset(uatuma, Classe == "Mammalia")
head(uatuma)
dim(uatuma)

sort(unique(uatuma$Ano))
...
encounter.rate(uatuma, "Especie")
#encounter_rate_uatuma
encounter_rate
...
# save jpeg
jpeg(here("experimental", "Alouatta_uatuma.jpg"), width=1000, height=600, res=120) # Open jpeg file
state.space.model(y, n.years)
dev.off()
...
state.space.model(y, n.years)
# save jpeg
jpeg(here("experimental", "Ateles_uatuma.jpg"), width=1000, height=600, res=120) # Open jpeg file
state.space.model(y, n.years)
dev.off()

mean_r_Ateles <- c(mean(meanR), quantile(meanR, probs = c(0.025, 0.975)) )
...
state.space.model(y, n.years)
# save jpeg
jpeg(here("experimental", "Chiropotes_uatuma.jpg"), width=1000, height=600, res=120) # Open jpeg file
state.space.model(y, n.years)
dev.off()
...
state.space.model(y, n.years)
# save jpeg
jpeg(here("experimental", "Dasyprocta_uatuma.jpg"), width=1000, height=600, res=120) # Open jpeg file
state.space.model(y, n.years)
dev.off()
...
state.space.model(y, n.years)
# save jpeg
jpeg(here("experimental", "Mazama_uatuma.jpg"), width=1000, height=600, res=120) # Open jpeg file
state.space.model(y, n.years)
dev.off()
...
state.space.model(y, n.years)
# save jpeg
jpeg(here("experimental", "Myoprocta_uatuma.jpg"), width=1000, height=600, res=120) # Open jpeg file
state.space.model(y, n.years)
dev.off()
...
state.space.model(y, n.years)
# save jpeg
jpeg(here("experimental", "Pecari_uatuma.jpg"), width=1000, height=600, res=120) # Open jpeg file
state.space.model(y, n.years)
dev.off()
...
state.space.model(y, n.years)
# save jpeg
jpeg(here("experimental", "Saguinus_uatuma.jpg"), width=1000, height=600, res=120) # Open jpeg file
state.space.model(y, n.years)
dev.off()
...
state.space.model(y, n.years)
# save jpeg
jpeg(here("experimental", "Sapajus_uatuma.jpg"), width=1000, height=600, res=120) # Open jpeg file
state.space.model(y, n.years)
dev.off()
...
#
meanRs <- rbind(mean_r_Allouata, mean_r_Ateles, mean_r_Chiropotes, mean_r_Dasyprocta, mean_r_Mazama, mean_r_Myoprocta, mean_r_Pecari, mean_r_Saguinus, mean_r_Sapajus)
...
write.csv(tabela1, here("experimental", "tabela1_uatuma.csv"), row.names = FALSE)

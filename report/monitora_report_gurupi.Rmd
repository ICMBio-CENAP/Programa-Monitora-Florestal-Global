...
A taxa de crescimento estocástico para *Dasyprocta prymnolopha* foi significativamente maior que zero (i.e., o intervalos de confiança inclui o zero), indicando que a população da espécie está aumentando. Para as outras espéces, a taxa de média de crescimento estocástico não foi significativamente diferente, indicando elas se mantiveram estáveis durante o período de monitoramento (Tabela 1).

...
Seis espécies atenderam aos critérios mínimos para inclusão nas análises: *Alouatta nigerrima, Chiropotes albinasus, Dasyproocta croconota, Mico humeralifer, Pecari tajacu, Sapajus apella*.

Em nenhum caso a taxa de média de crescimento foi significativamente diferente de zero (i.e., todos os intervalos de confiança incluem o zero), indicando que todas as espécies se mantiveram estáveis durante o período de monitoramento (Tabela 1). As Figuras 1 a 6 mostram a dinâmica do índice populacional (taxa de encontro anual) para as espécies selecionadas.

REssalta-se que os intervalos de confiança foram muito amplos, o que evidencia a  incerteza das estimativas. Isso decorre da variabilidade natural do sistema e das limitações do método de amostragem. Além disso, o esforço amostral prescrito pelo protocolo básico pode ser insuficiente para detectar tendências populacionais sutis, ao menos em prazos curtos. A continuação do monitoramento é essencial para revelar se há tendências populacionais consistentes.

Nessa análise, os dados de todas as trilhas foram agrupados. No entanto, o desenho amostral para a Resex Tapajós-Arapiuns possui trilhas em áreas sob diferentes níveis de pressão antrópica. Relatórios futuros poderão analisar se há variação nas tendências temporais de algumas espécies entre diferentes regiões da reserva.


```{r, echo=FALSE}
#library(kableExtra)
knitr::kable(
  read.csv("/home/elildojr/Documents/r/Programa-Monitora-Florestal-Global/experimental/tabela1_tapajos_arapiuns.csv"), caption = 'Taxa estocástica de crescimento populacional (*r*), intervalo de confiança (IC) e tendência populacional para espécies selecionadas da RESEX Tapajós-Arapiuns'
) 
```


![Taxa de encontro anual para *Alouatta nigerrima*. As barras verticais indicam a incerteza associada à estimativa (intervalo de confiança de 95%)](/home/elildojr/Documents/r/Programa-Monitora-Florestal-Global/experimental/Alouatta_TapArap.jpg)

![Taxa de encontro anual para *Chiropotes albinasus*. As barras verticais indicam a incerteza associada à estimativa (intervalo de confiança de 95%)](/home/elildojr/Documents/r/Programa-Monitora-Florestal-Global/experimental/Chiropotes_TapArap.jpg)

![Taxa de encontro anual para *Dasyprocta croconota*. As barras verticais indicam a incerteza associada à estimativa (intervalo de confiança de 95%)](/home/elildojr/Documents/r/Programa-Monitora-Florestal-Global/experimental/Dasyprocta_TapArap.jpg)

![Taxa de encontro anual para *Mico humeralifer*. As barras verticais indicam a incerteza associada à estimativa (intervalo de confiança de 95%)](/home/elildojr/Documents/r/Programa-Monitora-Florestal-Global/experimental/Mico_TapArap.jpg)

![Taxa de encontro anual para *Pecari tajacu*. As barras verticais indicam a incerteza associada à estimativa (intervalo de confiança de 95%)](/home/elildojr/Documents/r/Programa-Monitora-Florestal-Global/experimental/Pecari_TapArap.jpg)

![Taxa de encontro anual para *Sapajus apella*. As barras verticais indicam a incerteza associada à estimativa (intervalo de confiança de 95%)](/home/elildojr/Documents/r/Programa-Monitora-Florestal-Global/experimental/Sapajus_TapArap.jpg)

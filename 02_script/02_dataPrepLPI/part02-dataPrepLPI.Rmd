...
#GERAR TABELA
knitr::kable(nRegistrosWideReport , caption = "Número de registros anuais por população")
```
\newpage
...
#GERAR TABELA
knitr::kable(taxas_anuais, caption = "Número de registros anuais por população")

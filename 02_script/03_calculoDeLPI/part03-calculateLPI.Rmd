...
mydata_lpi <- taxas_anuais %>%
  ...
  dplyr::select(cnuc, ID, Binomial, X2014, X2015, X2016, X2017, X2018, X2019)

names(mydata_lpi) = gsub(pattern = "X", replacement = "", x = names(mydata_lpi))
```
...
x <- as.numeric(colnames(mydata_lpi)[4])
y <- as.numeric(colnames(mydata_lpi[tail(names(mydata_lpi), 1)]))

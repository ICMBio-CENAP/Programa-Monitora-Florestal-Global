...
dados <-  readr::read_csv("../../01_dadosDeEntrada/Planilha.consolidada.mastoaves.ate.2019a.csv", show_col_types = FALSE)
...
#CORREÇÃO DE NOMES CIENTÍFICOS
  ...
  dplyr::mutate(binomial = case_when(
...
```{r exportar}
saveRDS(dados, "../../03_dadosDeSaida/dados/dadosICMBio_2014a2019.rds")
write_csv(dados, "../../03_dadosDeSaida/dados/dadosICMBio_2014a2019.txt")
```
\newpage
...
```{r}
dados <-  readr::read_csv("../../01_dadosDeEntrada/Dados_Florestal_14a18_disponibilizacao1.csv", show_col_types = FALSE)
```
...
```{r}
saveRDS(dados, "../../03_dadosDeSaida/dados/dadosICMBio_2014a2018.rds")
write_csv(dados, "../../03_dadosDeSaida/dados/dadosICMBio_2014a2018.txt")
```
